...
import { FaTachometerAlt, FaChartLine, FaHistory, FaSearch, FaUserCog, FaSignOutAlt } from 'react-icons/fa';
...
const sidebarLinks = [
   {
      label: 'Quick Stats',
      icon: <FaTachometerAlt size={ 25 } className="text-[#FACC15]" />,
      to: '/investor/dashboard',
   },
   {
      label: 'My Investments',
      icon: <FaChartLine size={ 25 } className="text-[#FACC15]" />,
      to: '/investor/investments',
   },
   {
      label: 'Investment History',
      icon: <FaHistory size={ 25 } className="text-[#FACC15]" />,
      to: '/investor/investment-history',
   },
   {
      label: 'Discover Project',
      icon: <FaSearch size={ 25 } className="text-[#FACC15]" />,
      to: '/investor/discover',
   },
   {
      label: 'Profile',
      icon: <FaUserCog size={ 25 } className="text-[#FACC15]" />,
      to: '/investor/profile',
   },
];
