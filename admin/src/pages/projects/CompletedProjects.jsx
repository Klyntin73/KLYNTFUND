...
import { Trash2, Loader, CheckCircle2, ArrowLeft } from "lucide-react";
...
const CompletedProjects = () => {
   ...
   const fetchCompletedProjects = async () => {
      try {
         const res = await axios.get(`${backendUrl}/api/admin/projects/completed`, {
   ...
   return (
      ...
      >
         ...
         <h1 className="text-2xl font-bold text-[#2C3E50] mb-4 flex items-center gap-2">
            <CheckCircle2 className="text-blue-500" /> Completed Projects
         </h1>
